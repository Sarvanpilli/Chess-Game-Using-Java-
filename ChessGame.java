...
public static void main(String[] args) {
        ...
        JFrame f = new JFrame("Group-9 Chess Project");                    
        f.add(gui);                                                                               
        f.setSize(475, 500);                                                         
        f.setVisible(true);                                                                       
    ...
    public static void movePiece(String move) {   
        if (moves%2 != 0) {                      
            if (move.charAt(4) != 'p') {
                ...
                if ("k".equals(board[Character.getNumericValue(move.charAt(2))][Character.getNumericValue(move.charAt(3))])) {   
    ...
    public static String possWhiteKnight(int i) {                    
        ...
        for (int j = -1; j <= 1; j += 2) {                                                       
            for (int k = -1; k <= 1; k += 2) {                                                        
                try {
                    if (Character.isLowerCase(board[row + j][col + k*2].charAt(0)) || " ".equals(board[row + j][col + k*2])) {   
                ...
                try {
                    if (Character.isLowerCase(board[row + j*2][col + k].charAt(0)) || " ".equals(board[row + j*2][col + k])) {           
    ...
    public static String possBlackKnight(int i) {                              
        ...
        for (int j = -1; j <= 1; j += 2) {                                                          
            for (int k = -1; k <= 1; k += 2) {                                                       
                try {
                    if (Character.isUpperCase(board[row + j][col + k*2].charAt(0)) || " ".equals(board[row + j][col + k*2])) {           
                        previous = board[row + j][col + k*2];                                                             
                        board[row][col] = " ";                                                                              
                        board[row + j][col + k*2] = "n";                                                                 
                        if (noBlackKingThreat() == true) {
                ...
                try {
                    if (Character.isUpperCase(board[row + j*2][col + k].charAt(0)) || " ".equals(board[row + j*2][col + k])) {                
                        previous = board[row + j*2][col + k];                                                     
                        board[row][col] = " ";                                                                      
                        board[row + j*2][col + k] = "n";                                                             
                        if (noBlackKingThreat() == true) {
    ...
    public static String possBlackKing(int i) {                                                   
        ...
        for (int j = 0; j < 9; j++) {               
            if (j != 4) {                               
                try {
                    if (Character.isUpperCase(board[row - 1 + j / 3][col - 1 + j % 3].charAt(0)) || " ".equals(board[row - 1 + j / 3][col - 1 + j % 3])) {         
                        previous = board[row - 1 + j / 3][col - 1 + j % 3];                                       
                        board[row][col] = " ";                                                                      
                        board[row - 1 + j / 3][col - 1 + j % 3] = "k";                                              
        ...
        for (int i = -1; i <= 1; i += 2) {                                                
            for (int j = -1; j <= 1; j += 2) {                                            
                try {
                    ...
                    if ("b".equals(board[whiteKing / 8 + foo*i][whiteKing % 8 + foo*j]) || "q".equals(board[whiteKing/8 + foo*i][whiteKing%8 + foo*j])) {    
                        return false;
                    }
                } catch (Exception e) { }
                foo = 1;                                                                    
        ...
        for (int i = -1; i <= 1; i += 2) {                                                        
            for (int j = -1; j <= 1; j += 2) {                                                        
                try {
                    ...
                    if ("B".equals(board[blackKing/8 + foo*i][blackKing%8 + foo*j]) || "Q".equals(board[blackKing/8 + foo*i][blackKing%8 + foo*j])) {               
                        return false;
                    }
                } catch (Exception e) {}
                foo = 1;                                                                    
