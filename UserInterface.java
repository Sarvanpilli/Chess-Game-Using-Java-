...
public class UserInterface extends JPanel implements MouseListener, MouseMotionListener {       
    ...
    public void paintComponent(Graphics g){
        ...
        for (int i = 0; i < 64; i ++){                        
            ...
            if (j!= -1 && k!= -1){
                g.drawImage(chessPieceArray, (i%8)*tile, (i/8)*tile, (i%8 + 1)*tile,(i/8 + 1)*tile,j*64, k*64,(j+1)*64,(k+1)*64,this) ;    
            }
        }
    }
    @Override
        ...
        if(e.getX() < 8*tile && e.getY() < 8*tile){             
            ...
            if(e.getButton() == MouseEvent.BUTTON1){                  
                if(newY/tile == 0 && Y/tile == 1 && "P".equals(ChessGame.board[Y/tile][X/tile])) {                           
                    ...
                    dragpiece = "" + Y/tile + X/tile + newY/tile + newX/tile + ChessGame.board[newY/tile][newX/tile];               
                }
